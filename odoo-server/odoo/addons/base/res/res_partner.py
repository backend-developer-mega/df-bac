...
class Partner(models.Model, FormatAddress):
    ...
    phone = fields.Char()
    fax = fields.Char()
    mobile = fields.Char(string="Telefono de contacto")
    is_company = fields.Boolean(string='Is a Company', default=False,
        help="Check if the contact is a company, otherwise it is a person")
    # company_type is only an interface field, do not use it in business logic
    company_type = fields.Selection(string='Tipo de usuario',
        selection=[('person', 'Egresado'), ('company', 'Personal administrativo')],
    ...
    is_invisible = fields.Boolean(string='Is root', default=False)
    ...
    @api.multi
    def _partner_all(self):
        domain = [('is_invisible','=',False)]
        _logger.info('$$$$$$$$----> %s', domain)
        return {
            'name': _('Usuarios registrados'),
            'domain': domain,
