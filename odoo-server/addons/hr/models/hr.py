...
class Job(models.Model):
    ...
    description = fields.Text(string='Descripción de la carrera')
    requirements = fields.Text('Requirements')
    department_id = fields.Many2one('hr.department', string='Department')
    company_id = fields.Many2one('res.company', string='Company', default=lambda self: self.env.user.company_id)
    state = fields.Selection([
        ('recruit', 'Inscripción en curso'),
        ('open', 'Cerrada la inscripción')
    ...
    partner_id = fields.Many2one('res.partner', string='Customer', related='user_id.partner_id', readonly=1)
    #department_user_actualy = fields.Char(related='partner_id.mobile', store=True, readonly=True)
    ...
    #     department_actu = self.env['res.partner'].search([('id', '=', partner_id_actu.id)],limit=1).mobile
...
class Department(models.Model):
    ...
    description = fields.Text(string='Descripción del departamento')
